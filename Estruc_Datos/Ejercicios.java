...
public class Ejercicios {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arreglo3.length; i++) { //bucle for
            for (int j = i + 1; j < arreglo3.length; j++) { //bucle for que recorre la posición siguiente a i hasta el fin
        ...
        for (int i = 0; i < arreglo4.length; i++) { //bucle for
            if (arreglo4[i] > mayor) { //si el elemento de arreglo4[i] es mayor que el elemento de la variable mayor se cambia el valor
                mayor = arreglo4[i];
            }
            if (arreglo4[i] < menor) { //si el elemento de arreglo4[i] es menor que el elemento de la variable menor se cambia el valor
                menor = arreglo4[i];
            }
        }
